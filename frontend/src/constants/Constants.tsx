...
export const projects = [
  ...
  },
  {
    ...
    description: 'Reinforcement-learning controller for a simulated 4-way intersection, comparing DQN and tabular Q-learning against fixed-time and longest-queue heuristics on a custom Gymnasium environment; Python, PyTorch, numpy, with a dependency-free browser replay viewer.',
    tech: ['Python', 'PyTorch', 'Gymnasium', 'DQN', 'NumPy'],
    categories: ['ai-ml', 'research'],
    link: 'https://jihushiru.github.io/rl-traffic/',
    source: 'https://github.com/JIhushiru/rl-traffic',
    screenshots: ['/screenshot_rl_baseline.png', '/screenshot_rl_dqn.png', '/screenshot_rl_curves.png'],
  },
  ...
  {
    title: 'Networked SEIR Epidemic Simulator',
    description: 'Interactive epidemic simulator solving a four-compartment SEIR ODE system across a 15-node barangay mobility network, using a hand-written fixed-step RK4 integrator with graph-diffusion coupling; built with React, TypeScript, and Recharts.',
    tech: ['React', 'TypeScript', 'Recharts', 'RK4', 'Vite'],
    categories: ['research'],
    link: '',
    source: 'https://github.com/JIhushiru/barangay-seir',
    screenshots: ['/screenshot_seir_dashboard.png', '/screenshot_seir_model.png'],
  },
  {
    title: 'Stable Fluids',
  ...
  {
    title: 'Connect Four vs MCTS',
    description: 'Browser Connect Four against a Monte Carlo Tree Search AI (UCB1 selection, random rollouts, explicit tree) that searches in requestAnimationFrame chunks and surfaces live per-column win estimates; Next.js, React, and TypeScript, with no dependencies beyond the framework.',
    tech: ['Next.js', 'React', 'TypeScript', 'MCTS'],
    categories: ['ai-ml'],
    link: '',
    source: 'https://github.com/JIhushiru/mcts-connect4',
    screenshot: '/screenshot_c4.png',
  },
  {
